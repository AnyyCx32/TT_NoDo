...
// ============================================================================
static const char FW_VERSION[] = "TT-NODO-R11-DEMO-TS-2S";
...
// ===== COPIA DE DEMOSTRACION - NO USAR EN OPERACION =====
// Periodo forzado a 2 s para demostrar que el limite de cadencia lo impone el
// servicio y no el nodo. Procedimiento: operar 10 min a cielo abierto,
// estacionario, y comparar dos cifras del mismo intervalo:
//   - HTTP OK en EVENTOS.LOG .......... deberian rondar los 300
//   - entradas nuevas en el canal ..... deberian rondar las 40 (600 s / 15)
// La diferencia entre ambas ES la demostracion. Ademas, cada rechazo queda
// marcado en la bitacora con "AVISO ThingSpeak descarto la actualizacion",
// porque el servicio responde 200 con un cuerpo de un solo byte, "0", en vez
// de senalar un error HTTP.
// Al terminar, recargar el firmware de operacion.
static const uint32_t SEND_PERIOD_MS = 2000;
...
// Piso desactivado a proposito: es justo lo que se quiere violar para que el
// servicio rechace y quede constancia del rechazo.
static const uint32_t TS_MIN_GAP_MS = 0;
...
static const uint8_t  MODEM_DEAF_STREAK_TRIGGER = 10;    // ~50 s mudo
